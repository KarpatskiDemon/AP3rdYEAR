...
public class LearningProcess extends LearningUnit {
    ...
    public void evaluateKnowledge() {
        System.out.println("LearningProcess.evaluateKnowledge");
    }

    public void teachStudent() {
        System.out.println("LearningProcess.teachStudent");
    }

    public void checkHomework() {
        System.out.println("LearningProcess.checkHomework");
    }

    public void communicate() {
        System.out.println("LearningProcess.communicate");
    }

    public void process() {
        System.out.println("LearningProcess.process");
    }
    ...
    protected void setMaterials(String materials) {
