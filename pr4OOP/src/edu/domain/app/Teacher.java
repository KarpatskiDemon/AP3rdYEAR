...
public class Teacher extends Person {
    ...
    public void createLesson() {
        System.out.println("Teacher.createLesson");
    }

    public void developMaterials() {
        System.out.println("Teacher.developMaterials");
    }

    public void conductOnlineLesson() {
        System.out.println("Teacher.conductOnlineLesson");
    }

    public void evaluateStudents() {
        System.out.println("Teacher.evaluateStudents");
    }

    public void communicateWithStudents() {
        System.out.println("Teacher.communicateWithStudents");
    }

    public void assignCuratorTo(Student student) {
        student.assignCurator(this);
    }
